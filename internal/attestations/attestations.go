...
type Attestations struct {
	...
	// with `tree-B`.
	referenceAuthorizations map[string]githash.Hash
	...
	githubPullRequestAttestations map[string]githash.Hash
	...
	codeReviewApprovalAttestations map[string]githash.Hash
...
func (a *Attestations) Commit(repo gitstore.Storer, commitMessage string, createRSLEntry, signCommit bool) error {
	...
	attestationsTreeID, err := repo.WriteTree(entries)
	if err != nil {
		return err
	}
