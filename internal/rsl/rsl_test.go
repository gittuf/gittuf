...
func TestPropagateChanges(t *testing.T) {
	...
	err := PropagateChanges(downstreamRepo, upstreamRepo, []*PropagationDetails{propagationDetails}, false)
	...
	upstreamRootTreeID, err := upstreamTreeBuilder.WriteRootTreeFromBlobIDs(map[string]gitinterface.Hash{
		"a": blobAID,
		"b": blobBID,
	})
	if err != nil {
	...
	downstreamRootTreeID, err := downstreamTreeBuilder.WriteRootTreeFromBlobIDs(map[string]gitinterface.Hash{
		"a":     blobAID,
		"foo/b": blobBID,
	})
	if err != nil {
	...
	expectedRootTreeID, err := downstreamTreeBuilder.WriteRootTreeFromBlobIDs(map[string]gitinterface.Hash{
		"a":          blobAID,
		"foo/b":      blobBID,
		"upstream/a": blobAID,
		"upstream/b": blobBID,
