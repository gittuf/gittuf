...
func verifyGlobalRules(repo *gitinterface.Repository, globalRules map[string][]tuf.GlobalRule, target string, opts ...verifyGlobalRulesOption) ([]*GlobalRuleVerificationReport, error) {
