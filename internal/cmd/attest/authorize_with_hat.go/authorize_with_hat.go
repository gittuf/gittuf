...
func (o *options) Run(cmd *cobra.Command, args []string) error {
	...
	if o.revoke {
		...
		return repo.RemoveReferenceAuthorization(cmd.Context(), signer, args[0], args[1], args[2], true) //need a hat authorization equivalent
	}
	...
	return repo.AddReferenceHatAuthorization(cmd.Context(), signer, args[0], o.hat, true, opts...)
}
