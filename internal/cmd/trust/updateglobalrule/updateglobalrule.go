...
func (o *options) Run(cmd *cobra.Command, _ []string) error {
	...
	case tuf.GlobalRuleThresholdType:
		...
		return repo.UpdateGlobalRuleThreshold(cmd.Context(), signer, o.ruleName, o.rulePatterns, o.threshold, true)
	...
	case tuf.GlobalRuleBlockForcePushesType:
		...
		return repo.UpdateGlobalRuleBlockForcePushes(cmd.Context(), signer, o.ruleName, o.rulePatterns, true)
