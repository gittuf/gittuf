...
func New() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:              "The 'list-hooks' command displays all gittuf hooks defined in the repository's trust policy, including their stage, ID, authorized principals, hashes, environment, and timeout.",
		RunE:              o.Run,
