...
func (o *options) Run(cmd *cobra.Command, _ []string) error {
	...
	return repo.UpdatePropagationDirective(cmd.Context(), signer, o.name, o.upstreamRepository, o.upstreamReference, o.upstreamPath, o.downstreamReference, o.downstreamPath, true, opts...)
}
