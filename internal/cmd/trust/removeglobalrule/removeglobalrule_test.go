...
func TestRemoveGlobalRule(t *testing.T) {
	t.Run("no repository", func(t *testing.T) {
		...
		_, _, _, err = cmd.ExecuteCommandC(New(pOpts), "--rule-name", "test-rule")
	...
	t.Run("success", func(t *testing.T) {
		...
		require.NoError(t, repo.AddGlobalRuleThreshold(t.Context(), signer, "test-rule", []string{"git:refs/heads/main"}, 1, false))
