...
func New(persistent *persistent.Options) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:              "The 'init' command initializes a gittuf root of trust for the current repository. This sets up the initial trusted root metadata and prepares the repository for trust policy operations. It can optionally specify the repository location and records initialization details in the repository's trust metadata.",
