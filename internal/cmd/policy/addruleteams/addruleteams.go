...
func New(persistent *persistent.Options) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:              `This command allows users to add a new rule to the specified policy file using the teams functionality. By default, the main policy file is selected. Roles may be specified as a JSON file. See the "teams-format.md" document in the docs directory for more information.`,
