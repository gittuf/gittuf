...
func TestAddKey(t *testing.T) {
	t.Run("no repository", func(t *testing.T) {
		...
		_, _, _, err = cmd.ExecuteCommandC(New(pOpts), "--public-key", "dummy-pub-key")
	...
	t.Run("invalid public key", func(t *testing.T) {
		...
		_, _, _, err = cmd.ExecuteCommandC(New(pOpts), "--public-key", "non-existent-pub-key")
		assert.ErrorContains(t, err, "failed to run command")
	})
	...
	t.Run("success", func(t *testing.T) {
		...
		_, _, _, err = cmd.ExecuteCommandC(New(pOpts), "--public-key", newKeyPath+".pub")
	...
	t.Run("success with custom policy name", func(t *testing.T) {
		...
		_, _, _, err = cmd.ExecuteCommandC(New(pOpts), "--public-key", newKeyPath+".pub", "--policy-name", "custom-policy")
		assert.NoError(t, err)
	})
}
