...
func TestTrustScreenInteractiveNavigation(t *testing.T) {
	...
	}, teatest.WithCheckInterval(time.Millisecond*50), teatest.WithDuration(time.Second*15))
	...
	require.GreaterOrEqual(t, trustIndex, 0, "Trust menu item should be found")
