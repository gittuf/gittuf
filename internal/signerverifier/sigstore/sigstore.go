...
func (v *Verifier) getTUFRoot() (root.TrustedMaterial, bool, error) {
	...
	// TODO: Support tsa
	// return root.NewTrustedRoot(root.TrustedRootMediaType01, fulcioRoot, ctLog, nil, rekorLog)

	fulcioRootFilePath := os.Getenv("SIGSTORE_ROOT_FILE")
	ctLogPublicKeyFilePath := os.Getenv("SIGSTORE_CT_LOG_PUBLIC_KEY_FILE")
	rekorPublicKeyFilePath := os.Getenv("SIGSTORE_REKOR_PUBLIC_KEY")
