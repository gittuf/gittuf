# gittuf User Programmable Policy Integration Extensions (GUPPIEs)
...
Integration Extensions (GUPPIEs), declared in a repository's policy metadata.
...
today, but have several improvements and advantages compared to them. GUPPIEs
