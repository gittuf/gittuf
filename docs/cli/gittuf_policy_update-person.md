...
```
      --associated-identity stringArray   identities on code review platforms in the form 'providerID::identity' (e.g., 'https://gittuf.dev/github-app::<username>+<user ID>') (replaces existing identities)
      --custom stringArray                custom metadata in the form KEY=VALUE (replaces existing metadata)
  -h, --help                              help for update-person
      ...
      --public-key stringArray            public keys for person (replaces existing keys)
```
